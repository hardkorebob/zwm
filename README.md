...
A reference extracted from `swm.c` (~2860 lines, single-file C window manager) for use as prompting context when asking Claude AI to produce robust systems software.
